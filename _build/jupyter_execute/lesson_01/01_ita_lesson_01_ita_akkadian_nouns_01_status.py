...
# 
# **Status rectus** is the inflected (nominative, genitiv, accusativ) form of the noun without genitive. 
# 
...
# | *bēlum* (nom.)  | lord        |
# 
# The endings in the *status rectus* contains the elemen *-m* and is called **mimation**. It begins to desappear already in the old Babylonian period, later on completely. For more details see 
# 
