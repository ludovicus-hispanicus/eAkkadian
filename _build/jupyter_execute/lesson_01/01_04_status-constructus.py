...
# 
# |  *Status Rectus* | *Status Constructus* | Example       | Translation      |
# | --------------   | :------------------: | :-----------: | ---------------: |
# | *bēlum*          | *bēl*                | *bēl aššatim* | Lord of the wife |
# | *šarrum*         | *šar*                | *šar mišārim* | King of the Justice  |
# | *aššatum*        | *aššat*              | *aššat awīlim* | Wife of the man |
# 
# ```{note}
# The status constructus can be dismatled by the [determinative pronoun *ša*](sha-ref)
# ```
# 
...
#   |  *Status Rectus* | *Status Constructus* | Example  | Translation  |
#   | --------------   | :------------------: | -------: | -----------: |  
#   | *abum* masc.      | *abi*                |         | father        | 
#   | *ṭuppum* masc.    | *ṭuppi*              |         | (clay) tablet | 
#   | *napištum* fem.   | *napišti*            |         | life          |
# 
...
#   |  *Status Rectus* | *Status Constructus* | Example  | Translation  | 
#   | --------------   | :------------------: | -------: | -----------: | 
#   | *kalbum* (PaRS)   | *kalab* (PaRaS)      |          | dog          | 
#   | *šiprum* (PiRS)   | *šipir* (PiRiS)      |          | sending       | 
# 
...
#   |  *Status Rectus* | *Status Constructus* | Example  | Translation  | 
#   | --------------   | :------------------: | -------: | -----------: | 
#   | *qištum* (<*qiš-at-u*)  | *qišti*        |          | wood, forest | 
#   | *šubtum* (<*šub-at-u*)   | *šubat*        |          | dwelling     | 
#   | *bēltum*          | *bēlet*              |          | lady         |
# 
#   ```{note}
...
#   | --------------   | :------------------: | -----------: | -----------: | 
#   | *kalbū*          | *kalbū*              |          | dogs         | 
#   | *šiprī*          | *šiprī*              |          | sendings     |
#   | *inān*           | *inā*                |          | eyes         |
# 
# - Masculine adjectives in plural loses the ending: 
#   |  *Status Rectus* | *Status Constructus* | Example  | Translation  | 
#   | --------------   | :------------------: | -------: | -----------: | 
#   | *dannūtum*       | *dannūt*             |          | mighty, strength | 
#   | *šiprī*          | *šiprī*              |          | sending      |  
# 
# - Feminine nouns in plural lose their ending
#   |  *Status Rectus* | *Status Constructus* | Example  | Translation  | 
#   | --------------   | :------------------: | -------: | -----------: | 
#   | *kalbātum*        | *kalbāt*             |          | she-dogs     | 
#   | *šarrātum*        | *šarrāt*             |          | queens       |
#   
#   ```{note}
