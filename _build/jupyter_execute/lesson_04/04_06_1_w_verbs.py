...
# | ------- | --------------  | --------   | ---------    |
# | 3s.c.   | *uššab*         | *ittašab*   | *ūšib*      | 
# | 2s.m.   | *tuššab*        | *tattašab* | *tūšib*     |
# | 2s.f.   | *tuššabī*       | *tattašabī* | *tušbī*
# | 1s.c.   | *uššab*         | *attašab*  | *ūšib*
# | 3pl.m.  | *uššabū*        | *ittašabū* | *ūšibū*, *ušbū*
# | 3pl.f.  | *uššabā*        | *ittašabā* | *ūšibā*, *ušibā*
# | 2pl.c.  | *tuššabā*       | *tattašabā* | *tūšibā*, *tušbā*
# | 1pl.c.  | *nuššab*        | *nittašab*  | *nūšib*
# 
# ## Paradigm of the verbs I-*w*
# |               | Durative        | Perfect    | Preterite    | Participle    | Infinitve | Verbal Adjective |
# | -------       | --------------  | --------   | ---------    | ------------  | --------  | ---------------  | 
# | G I-*w*       | *ubbal*         | *ittabal*  | *ūbil*       | *bābilum*     | *babālum* | --               |
# 
# 
