...
# | --------------- | ----------- | ------------ | ------------ | ------ |  
# | Infinitve       | *parāsum*     | *mahāṣum*      | to strike      | 
# | Participle      | *pārisum*     | *šāriqum*      | the one that steal |
...
# | *D*               | Length of *R₂*    | Causative, pluralic           | 
...
# | *kašādum* act.-intr. | to arrive | *mūšu ikaššad* | The night falls |
#     
