...
# | *R₁uR₂R₂uR₃*      | *purrusum*            | Verb in infinitive with doubling of the second radical + Suffix (nominative ending) | cut of     |
# | *iR₁R₂uR₃*        | *iprus*               | Verb in preterite                      | he decided |
# | *R₁aR₂uR₃*        | *parsum*              | Adjective + Suffix (nominative ending)  | cut off, separate |
# | *R₁iR₂R₃*         | *pirsum*              | Noun + Suffix (nominative ending)       | divsion   |
# 
# ```{note}
...
# ```
# 
# There are also roots of two, four and five, though the latter is very rare:
# 
