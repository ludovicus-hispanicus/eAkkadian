...
# [^thomas_hyde_1700]: Thomas Hyde (1700), 526. «Istiusmodi enim ductuli pyramidales seu Cuneiformes [...].» But he didn't these signs were a script: «Neque ea est Literarum aut Characterum aliqua Scriptura legenda, sed tantum Sculptura ornamenti causa.»
# 
# ## Development
...
# 
#     | Sign | Logogram | Akkadian |Meaning |
#     | -------- | -------- | --------- |----|
#     | 𒌓 | UTU | *šamaš* |sun
#     | 𒌓 | U₄ | *umu* |day
#     | 𒌓 | BABBAR | *peṣû* | white
...
# 
#     | Sign | Sign Name | Determinativ | Semantic Field
#     | -------- | -------- | --| ---|
#     | 𒀭 | AN | dingir | Deities
#     | 𒄑 | GIŠ |ĝeš | Wood objects |
#     | 𒌑 | U₂| u₂ | Plant names |
#     | 𒆳 | KUR| kur | Cities Name |
#    
...
# | -------- | -------- | --| ---| ---|
# | 𒀭 | AN | AN (heaven)|an | dingir
# | 𒄑 | GIŠ |GIŠ (wood) | is | ĝeš
# | 𒆳 | KUR| KUR (land) | mat | kur
# | 𒀀 | A | A (water) | a | -
# | 𒆷 | LA | LA (plenty) | la | - | 
#     
# Example
