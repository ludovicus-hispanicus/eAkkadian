...
# ---
# name: classification-semitic
# ---
# Genetic classification of the Semitic languages. Rebecca Hasselbach-Andee (2021), p. 135
# ```
# 
# It is still a matter of debate if Eblaite has to be considered as a language on its own or a dialect of an East Semitic laguage that comprises also Akkadian. See AoG xxi-xxiii; ABG §1.
